 ...
 * @author trieu
 */
public class HoanThanhCVJDialog extends javax.swing.JFrame {

    /**
     * Creates new form CongViecJDialog
     */
    public HoanThanhCVJDialog() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        paneldanhsach.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 78, 620, 140));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoanThanhCVJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HoanThanhCVJDialog().setVisible(true);
            }
        });
    }
